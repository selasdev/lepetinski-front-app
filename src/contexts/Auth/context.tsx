...
export const AuthenticationProvider: FC<IAuthenticationProvider> = ({ values, children }) => {
  const [authenticated, setAuthenticated] = useState<boolean>(values.authenticated || false)
